...
def process_raw(
    ...
    # Machine-readable real column count for the WPF host to log (its live
    # scanline count is a sparse ~14-line preview, not the true scan length).
    print(f"COLUMNS={len(scanlines)}", file=sys.stderr)
